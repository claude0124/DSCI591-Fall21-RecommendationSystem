...
Tshirt = {
    "name" : name,
    "price" : price,    #NOTE: This one has trouble
...
def scrapping_pipeline(url):
    ...
    for link in productLinks:
        ...
        Tshirt = {}
        Tshirt["name"] = soup.find('h1', class_ = "primary product-item-headline").text.strip()
        Tshirt["supplier"] = soup.find_all("ul", class_ = "ProductBackground-module--sustainabilityList__9jGol")        #NOTE: trouble 
        Tshirt["rating"] = soup.find('div', class_ = "star-average-number js-stars-number")         #NOTE: trouble 
        Tshirt["reviews"] = soup.find('h2', class_ = "sidedrawer__heading", id = "js-review-heading").text      #NOTE: trouble 
        Tshirt["price"] = soup.find('div', class_ = "ProductPrice-module--productItemPrice__2i2Hc")    #NOTE: trouble 
        try:
