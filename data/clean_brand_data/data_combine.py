#%%
# Last updated 02/25/22 by Dayun
import pandas as pd


# read in each csv file collected from websites
#@@ by 12-02-2021
df_zara = pd.read_csv(r"./data/clean_brand_data/zara_clean.csv", index_col=[0])
df_hm = pd.read_csv(r"./data/clean_brand_data/hm_clean.csv", index_col=[0])
df_uniqlo = pd.read_csv(r"./data/clean_brand_data/uniqlo_clean.csv", index_col=[0])
df_tentree = pd.read_csv(r"./data/clean_brand_data/tentree_clean.csv", index_col=[0])
df_thegoodtee = pd.read_csv(r"./data/clean_brand_data/thegoodtee_clean.csv", index_col=[0])
df_dedicated = pd.read_csv(r"./data/clean_brand_data/dedicated_clean.csv", index_col=[0])
df_outlanddenim = pd.read_csv(r"./data/clean_brand_data/outlanddenim_clean.csv", index_col=[0])
df_thestandardstitch = pd.read_csv(r"./data/clean_brand_data/thestandardstitch_clean.csv", index_col=[0])
df_fairIndigo = pd.read_csv(r"./data/clean_brand_data/fairindigo_clean.csv", index_col=[0])
df_zerum = pd.read_csv(r"./data/clean_brand_data/zerum_clean.csv", index_col=[0])
df_livingCraft = pd.read_csv(r"./data/clean_brand_data/livingCraft_clean.csv", index_col=[0])

#@@ by 02-13-2022
df_chnge = pd.read_csv(r"./data/clean_brand_data/chnge_clean.csv", index_col=[0])
df_dorsu = pd.read_csv(r"./data/clean_brand_data/dorsu_clean.csv", index_col=[0])
df_etiko = pd.read_csv(r"./data/clean_brand_data/etiko_clean.csv", index_col=[0])
df_mate = pd.read_csv(r"./data/clean_brand_data/mate_clean.csv", index_col=[0])
df_lyb = pd.read_csv(r"./data/clean_brand_data/littleyellowbird_clean.csv", index_col=[0])
df_rapanui = pd.read_csv(r"./data/clean_brand_data/rapanui_clean.csv", index_col=[0])
df_bws = pd.read_csv(r"./data/clean_brand_data/brotherswestand_clean.csv", index_col=[0])
df_njeans = pd.read_csv(r"./data/clean_brand_data/nudiejeans_clean.csv", index_col=[0])
df_kuyichi = pd.read_csv(r"./data/clean_brand_data/kuyichi_clean.csv", index_col=[0])
df_bleed = pd.read_csv(r"./data/clean_brand_data/bleed_clean.csv", index_col=[0])
df_aagnels = pd.read_csv(r"./data/clean_brand_data/armedangels_clean.csv", index_col=[0])
df_classic = pd.read_csv(r"./data/clean_brand_data/theclassictshirt_clean.csv", index_col=[0])
...
# add a column of unique id
id_lst = list(range(len(df)))
